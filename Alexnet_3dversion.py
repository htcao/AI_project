...
class Alexnet(nn.Module):
    ...
    def __init__(self):
        ...
        self.features = nn.Sequential(
            nn.Conv3d(1, 64, kernel_size=(3, 11, 11), stride=(1, 4, 4), padding=(0, 2, 2)),
            nn.BatchNorm3d(64),
            nn.ReLU(inplace=True),
            nn.MaxPool3d(kernel_size=(1, 3, 3), stride=(1, 2, 2)),
            nn.Conv3d(64, 192, kernel_size=(3, 5, 5), padding=(0, 2, 2)),
            nn.BatchNorm3d(192),
            nn.ReLU(inplace=True),
            nn.MaxPool3d(kernel_size=(1, 3, 3), stride=(1, 2, 2)),
            ...
            nn.ReLU(inplace=True),
            nn.Conv3d(256, 256, kernel_size=3, padding=(1, 1, 1)),
            nn.ReLU(inplace=True),
            nn.MaxPool3d(kernel_size=(1, 3, 3), stride=(1, 2, 2)),
        )
